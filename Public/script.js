...
function updateModelLabel() {
    ...
    if (existingLabel) {
        ...
        label.style.background = '#1a1a1a'; /* 深黑色 */
...
function createDeepSeekModelSwitch() {
    ...
    chatButton.style.background = currentDeepSeekModel === 'deepseek-chat' ? '#565869' : '#1a1a1a'; /* 深黑色 */
    ...
    reasonerButton.style.background = currentDeepSeekModel === 'deepseek-reasoner' ? '#565869' : '#1a1a1a'; /* 深黑色 */
    ...
    chatButton.addEventListener('click', () => {
        ...
        reasonerButton.style.background = '#1a1a1a'; /* 深黑色 */
        updateModelLabel();
    ...
    reasonerButton.addEventListener('click', () => {
        ...
        chatButton.style.background = '#1a1a1a'; /* 深黑色 */
        updateModelLabel();
